"------------------------------------------------------------
" Name: hololiveEN.vim
" Description: Hololive EN colorscheme for vim.
" Maintainer: tew
"------------------------------------------------------------
...
function! s:set() abort
  ...
  if &background ==# 'light'
    ...
    let highlight_group.CursorColumn = [none,        gray6,       none,      none]
    " Statusline
    ...
    " Message
    let highlight_group.ErrorMsg     = [mori,        none,        none,      none]
